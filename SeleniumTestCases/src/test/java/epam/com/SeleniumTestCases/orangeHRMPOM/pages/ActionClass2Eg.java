...
//	private WebElement form;
	...
	public ActionClass2Eg(WebDriver driver) {
	...
	public ActionClass2Eg enterUserName(String userName) {
		this.userName.sendKeys(userName);
		return this;
	}

	public ActionClass2Eg enterPassword(String password) {
...
//		this.loginButton.click();
	...
	public ActionClass2Eg jsEx(String userName) {
